    ...
    <div className="flex flex-col sm:flex-row bg-transparent bg-red-600 font-outfit">
      <div
        className={clsx(
          ...
          "bg-gradient-to-b from-results-summary-light-slate-blue to-results-summary-light-royal-blue",
          "text-center",
          "p-8 space-y-4 sm:space-y-6",
          "text-white"
        )}
      >
        <p className="text-results-summary-pale-blue">Your Result</p>
        <div
          className={clsx(
            "flex flex-col justify-center items-center",
            "w-[130px] h-[130px] sm:w-[150px] sm:h-[150px]",
            "rounded-full",
            "bg-gradient-to-b from-results-summary-violet-blue to-results-summary-persian-blue shadow-inner",
            "space-y-3"
          )}
        >
          <p className="text-5xl font-bold mt-5">76</p>
          <p className="text-results-summary-pale-blue text-sm opacity-50">
            of 100
          </p>
        </div>
